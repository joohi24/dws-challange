...
public class AccountsControllerTest {
	...
	public void createAccount() throws Exception {
		this.mockMvc.perform(post("/v1/accounts").contentType(MediaType.APPLICATION_JSON)
				.content("{\"accountId\":\"Id-10\",\"balance\":1000}")).andExpect(status().isCreated());

		Account account = accountsService.getAccount("Id-10");
		assertThat(account.getAccountId()).isEqualTo("Id-10");
...
//		TransferMoneyDto transferMoneyDto = new TransferMoneyDto(new BigDecimal("100"), "Id-1", "Id-2");
		this.mockMvc
				.perform(post("/v1/accounts/fundTransfer").contentType(MediaType.APPLICATION_JSON)
						.content("{\"accountFrom\":\"Id-1\",\"accountTo\":\"Id-2\",\"amount\":100}"))
